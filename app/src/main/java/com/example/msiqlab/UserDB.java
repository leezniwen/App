...
public class UserDB {
    ...
    public static final String DeptID_COLUMN = "_DeptID";
    public static final String F_OrgID_COLUMN = "_F_OrgID";
    ...
    public static final String WebFlowBoss_COLUMN = "_WebFlowBoss";
    public static final String WebFlowBossName_COLUMN = "_WebFlowBossName";
    public static final String WebFlowBossTel_COLUMN = "_WebFlowBossTel";
    ...
    public static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + "( " +
            ...
            "_WebFlowBoss VARCHAR(50)," +

            "_WebFlowBossName VARCHAR(50)," +

            "_WebFlowBossTel VARCHAR(50)," +
    ...
    public UserData insert(UserData item) {
        ...
        cv.put(DeptID_COLUMN, item.DeptID);
        cv.put(F_OrgID_COLUMN, item.F_OrgID);
        cv.put(Account_COLUMN, item.Account);
        cv.put(Email_COLUMN, item.Email);
        ...
        cv.put(WebFlowBoss_COLUMN, item.WebFlowBoss);
        cv.put(WebFlowBossName_COLUMN, item.WebFlowBossName);
        cv.put(WebFlowBossTel_COLUMN, item.WebFlowBossTel);
        cv.put(Region_COLUMN, item.Region);
    ...
    public UserData get(String WorkID) {
        ...
        String where = "_WorkID" + "=" + WorkID;
        // 執行查詢
        Cursor result = db.rawQuery("SELECT _fontsize,_DeptID,_F_OrgID,_Account,_Email,_Password,_WorkID,_Name,_Dept,_Phone,_EName,_WebFlowBoss,_WebFlowBossName,_WebFlowBossTel,_Region,_LastTab FROM " + TABLE_NAME + where, null);
...
//        _fontsize,_Account,_Password,_WorkID,_Name,_Dept,_Phone,_EName
        ...
        String DeptID = cursor.getString(cursor.getColumnIndex("_DeptID"));
        String F_OrgID = cursor.getString(cursor.getColumnIndex("_F_OrgID"));
        ...
        String WebFlowBoss = cursor.getString(cursor.getColumnIndex("_WebFlowBoss"));
        String WebFlowBossName = cursor.getString(cursor.getColumnIndex("_WebFlowBossName"));
        String WebFlowBossTel = cursor.getString(cursor.getColumnIndex("_WebFlowBossTel"));
        String Region = cursor.getString(cursor.getColumnIndex("_Region"));
        String LastTab = cursor.getString(cursor.getColumnIndex("_LastTab"));

        UserData result = new UserData(DeptID,F_OrgID,Account,Email,Password, WorkID, Name, Dept, Phone, EName,WebFlowBoss,WebFlowBossName,WebFlowBossTel,Region, LastTab);
        // 回傳結果
        return result;
    }
